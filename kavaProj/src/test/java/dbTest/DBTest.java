...
public class DBTest {
    ...
    public void testDataFromDB() throws SQLException, ClassNotFoundException {
        final String LOGIN = "G6_kostia";

        ArrayList<Map<String, String>> dataFromSeleniumTable =
                mysqlDB.selectTableAsMap(String.format("SELECT * FROM seleniumTable WHERE idNumber = '%s'", LOGIN));
...
//        log.info(dataFromSeleniumTable.get(1).get("login"));
        ...
        int numberOfRows =
                mysqlDB.changeTable("INSERT INTO seleniumTable VALUES(7, '%s', '101010')", LOGIN);
        ...
        log.info(db_util.getPassForLogin("G5"));
